...
const EditBooks = () => {
  ...
  const bookCategories = [
    ...
    "Business", "Memoir", "Poetry", "Children's books", "Travel", "Religion and spirituality",
  ...
  return (
    <div className='px-4 my-12'>
      <h2 className='mb-8 text-3xl font-bold text-purple-800'>Update Book Details!</h2>
      <form className="flex lg:w-[1180px] flex-col flex-wrap gap-4" onSubmit={updateBookObj}>
